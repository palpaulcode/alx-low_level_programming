#include "main.h"
/**
 * print_times_table - prints times table of a given  number starting with 0
...
{
	int cnt, lp, res;	/* cnt-counter for loop1 np-counter
				 * for loop2 res-multiplication result
				 */
	cnt = 0;
	if ((n >= 0) && (n < 15))
	{
